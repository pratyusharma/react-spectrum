...
Buttons can display a nostalgic terminal-style loading animation with cycling dots instead of the default spinner. This provides a retro, developer-friendly aesthetic for your applications. Use the `loadingStyle="terminal"` prop to enable this animation.
  ...
  return (
    <Flex direction="column" gap="size-200">
      ...
      <Button 
        ...
        onPress={() => {
          setIsCompiling(true);
          setTimeout(() => setIsCompiling(false), 4000);
        }}
      >
        Build Project
      </Button>
...
The terminal loading animation maintains the same accessibility features as the default spinner:
- Screen reader announcements when loading starts and ends
